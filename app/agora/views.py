...
print("=======================================================")
print("=======================================================")
print(os.environ.get('PUSHER_APP_ID'))
print(os.environ.get('PUSHER_CLUSTER'))
print("=======================================================")
print("=======================================================")
print("=======================================================")
...
def generate_agora_token():
    print("AGORA APP ID: ", os.environ.get('AGORA_APP_ID'))
    print("AGORA APP Certificate: ", os.environ.get('AGORA_APP_CERTIFICATE'))
    auth_user = current_user.to_json()
...
def call_user():
    ...
    auth_user = current_user.to_json()
    print(auth_user)
    print(request.json['user_to_call'])
    print(request.json['channel_name'])
